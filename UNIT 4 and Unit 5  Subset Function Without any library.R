...
#if it is asked that using subset function or using subset find out the follwing analysis than don't use dplyr
...
#finding out was class in which ticket were booked were also preferd during survival or not
#answer yes first class has most survival rate
